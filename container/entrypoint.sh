...
# a2ml-pre-commit container entrypoint
#
...
cleanup() {
    echo "Received shutdown signal — stopping a2ml-pre-commit..."
...
# Examples:
#   exec /app/a2ml-pre-commit
#   exec /app/release/bin/a2ml-pre-commit start
#   exec /app/a2ml-pre-commit serve --host "${APP_HOST}" --port "${APP_PORT}"
