...
#
# a2ml-pre-commit — Cerro Torre build, sign, and verify pipeline
#
...
#   CT_KEY_ID       — Signing key identifier (default: a2ml-pre-commit-release)
