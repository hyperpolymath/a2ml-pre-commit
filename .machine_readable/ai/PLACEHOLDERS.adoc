...
sed -i 's/a2ml-pre-commit/my-project/g' $(grep -rl 'a2ml-pre-commit' .)
...
| Placeholder | Description | Example | Files |
|---|---|---|---|
| `a2ml-pre-commit` | Human-readable project name | `My Project` | SECURITY.md, CODE_OF_CONDUCT.md, TOPOLOGY.md, STATE.a2ml, Justfile, GOVERNANCE.md, MAINTAINERS.md, flake.nix, devcontainer.json |
...
| `a2ml-pre-commit` | Repository name (slug) | `my-project` | CONTRIBUTING.md, SECURITY.md, CODE_OF_CONDUCT.md, cliff.toml |
...
| `https://github.com/hyperpolymath/a2ml-pre-commit` | Project website | `https://example.org` | SECURITY.md |
